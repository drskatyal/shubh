...
Keys stay out of the binary. Copy [`.env.example`](.env.example) and read [docs/KEYS.md](docs/KEYS.md). Backend decision: [docs/BACKEND.md](docs/BACKEND.md). The app boots with every value empty.
