...
const styles = StyleSheet.create({
  ...
  brand: { color: color.gold, fontSize: 13, letterSpacing: 1.2, textTransform: 'uppercase' },
  names: { color: color.ivory, fontSize: 18, fontWeight: '600', textAlign: 'center' },
  score: { color: color.ivory, fontSize: 64, fontWeight: '700', textAlign: 'center' },
